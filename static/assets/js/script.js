...
$("body").append('<div class="fixed-button active"><a href="" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Home</a> </div>');var $window=$(window),nav=$(".fixed-button");
